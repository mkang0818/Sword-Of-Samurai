	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				half2 texCoord183 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				half2 temp_output_182_0 = ( texCoord183 * _DetailUVScale );
				...
				half2 texCoord194 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				...
				half3 unpack96 = UnpackNormalScale( tex2D( _BaseNormalMap, uv_BaseNormalMap96 ), _BumpScale );
				unpack96.z = lerp( 1, unpack96.z, saturate(_BumpScale) );
				half3 tex2DNode96 = unpack96;
				...
				half2 texCoord279 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				...
				half3 unpack188 = UnpackNormalScale( tex2D( _DetailNormalMap, Detail_UVScale191 ), _DetailNormalMapIntensity );
				unpack188.z = lerp( 1, unpack188.z, saturate(_DetailNormalMapIntensity) );
				float2 uv_BaseNormalMap288 = IN.ase_texcoord8.xy;
				half3 unpack288 = UnpackNormalScale( tex2D( _BaseNormalMap, uv_BaseNormalMap288 ), ( _BumpScale * 0.5 ) );
				unpack288.z = lerp( 1, unpack288.z, saturate(( _BumpScale * 0.5 )) );
				half2 Top_UVScale197 = temp_output_195_0;
				half3 unpack119 = UnpackNormalScale( tex2D( _TopNormalMap, Top_UVScale197 ), _TopNormalIntensity );
				unpack119.z = lerp( 1, unpack119.z, saturate(_TopNormalIntensity) );
				half3 lerpResult158 = lerp( BlendNormal( unpack188 , tex2DNode96 ) , BlendNormal( unpack288 , unpack119 ) , ( Top_Mask168 * Top_Noise225 ).rgb);
				...
				float3 BaseColor = Output_Albedo318.rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half4 tex2DNode162 = tex2D( _BaseAlbedoASmoothness, uv_BaseAlbedoASmoothness162 );
				half4 temp_output_163_0 = ( _BaseColor * tex2DNode162 );
				half2 texCoord183 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				half2 temp_output_182_0 = ( texCoord183 * _DetailUVScale );
				half4 blendOpSrc178 = ( tex2D( _DetailAlbedo, temp_output_182_0 ) * 2.0 );
				half4 blendOpDest178 = temp_output_163_0;
				half4 lerpResult187 = lerp( temp_output_163_0 , ( saturate( (( blendOpDest178 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest178 ) * ( 1.0 - blendOpSrc178 ) ) : ( 2.0 * blendOpDest178 * blendOpSrc178 ) ) )) , _DetailAlbedoIntensity);
				half2 texCoord194 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				half2 temp_output_195_0 = ( texCoord194 * _TopUVScale );
				half4 tex2DNode172 = tex2D( _TopAlbedoASmoothness, temp_output_195_0 );
				...
				half3 worldNormal93 = float3(dot(tanToWorld0,tanNormal93), dot(tanToWorld1,tanNormal93), dot(tanToWorld2,tanNormal93));
				half Top_Mask168 = ( saturate( ( pow( abs( ( saturate( worldNormal93.y ) + ( _TopOffset * AGP_SnowOffset ) ) ) , ( (1.0 + (_TopContrast - 0.0) * (20.0 - 1.0) / (1.0 - 0.0)) * AGP_SnowContrast ) ) * ( _TopIntensity * AGP_SnowIntensity ) ) ) * saturate( (0.0 + (WorldPosition.y - AGH_SnowMinimumHeight) * (1.0 - 0.0) / (( AGH_SnowMinimumHeight + AGH_SnowFadeHeight ) - AGH_SnowMinimumHeight)) ) );
				half2 texCoord279 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_cast_0 = (( 1.0 - tex2D( _BaseAOANoiseMask, ( texCoord279 * _TopNoiseUVScale ) ).a )).xxxx;
				#ifdef _TOPENABLENOISE_ON
				float4 staticSwitch270 = temp_cast_0;
				#else
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half4 tex2DNode162 = tex2D( _BaseAlbedoASmoothness, uv_BaseAlbedoASmoothness162 );
				half4 temp_output_163_0 = ( _BaseColor * tex2DNode162 );
				half2 texCoord183 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				half2 temp_output_182_0 = ( texCoord183 * _DetailUVScale );
				half4 blendOpSrc178 = ( tex2D( _DetailAlbedo, temp_output_182_0 ) * 2.0 );
				half4 blendOpDest178 = temp_output_163_0;
				half4 lerpResult187 = lerp( temp_output_163_0 , ( saturate( (( blendOpDest178 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest178 ) * ( 1.0 - blendOpSrc178 ) ) : ( 2.0 * blendOpDest178 * blendOpSrc178 ) ) )) , _DetailAlbedoIntensity);
				half2 texCoord194 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				half2 temp_output_195_0 = ( texCoord194 * _TopUVScale );
				half4 tex2DNode172 = tex2D( _TopAlbedoASmoothness, temp_output_195_0 );
				...
				half3 worldNormal93 = float3(dot(tanToWorld0,tanNormal93), dot(tanToWorld1,tanNormal93), dot(tanToWorld2,tanNormal93));
				half Top_Mask168 = ( saturate( ( pow( abs( ( saturate( worldNormal93.y ) + ( _TopOffset * AGP_SnowOffset ) ) ) , ( (1.0 + (_TopContrast - 0.0) * (20.0 - 1.0) / (1.0 - 0.0)) * AGP_SnowContrast ) ) * ( _TopIntensity * AGP_SnowIntensity ) ) ) * saturate( (0.0 + (WorldPosition.y - AGH_SnowMinimumHeight) * (1.0 - 0.0) / (( AGH_SnowMinimumHeight + AGH_SnowFadeHeight ) - AGH_SnowMinimumHeight)) ) );
				half2 texCoord279 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_cast_0 = (( 1.0 - tex2D( _BaseAOANoiseMask, ( texCoord279 * _TopNoiseUVScale ) ).a )).xxxx;
				#ifdef _TOPENABLENOISE_ON
				float4 staticSwitch270 = temp_cast_0;
				#else
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				half2 texCoord183 = IN.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				half2 temp_output_182_0 = ( texCoord183 * _DetailUVScale );
				half2 Detail_UVScale191 = temp_output_182_0;
				half3 unpack188 = UnpackNormalScale( tex2D( _DetailNormalMap, Detail_UVScale191 ), _DetailNormalMapIntensity );
				unpack188.z = lerp( 1, unpack188.z, saturate(_DetailNormalMapIntensity) );
				float2 uv_BaseNormalMap96 = IN.ase_texcoord5.xy;
				half3 unpack96 = UnpackNormalScale( tex2D( _BaseNormalMap, uv_BaseNormalMap96 ), _BumpScale );
				unpack96.z = lerp( 1, unpack96.z, saturate(_BumpScale) );
				half3 tex2DNode96 = unpack96;
				float2 uv_BaseNormalMap288 = IN.ase_texcoord5.xy;
				half3 unpack288 = UnpackNormalScale( tex2D( _BaseNormalMap, uv_BaseNormalMap288 ), ( _BumpScale * 0.5 ) );
				unpack288.z = lerp( 1, unpack288.z, saturate(( _BumpScale * 0.5 )) );
				half2 texCoord194 = IN.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				half2 temp_output_195_0 = ( texCoord194 * _TopUVScale );
				half2 Top_UVScale197 = temp_output_195_0;
				half3 unpack119 = UnpackNormalScale( tex2D( _TopNormalMap, Top_UVScale197 ), _TopNormalIntensity );
				unpack119.z = lerp( 1, unpack119.z, saturate(_TopNormalIntensity) );
				...
				half3 worldNormal93 = float3(dot(tanToWorld0,tanNormal93), dot(tanToWorld1,tanNormal93), dot(tanToWorld2,tanNormal93));
				half Top_Mask168 = ( saturate( ( pow( abs( ( saturate( worldNormal93.y ) + ( _TopOffset * AGP_SnowOffset ) ) ) , ( (1.0 + (_TopContrast - 0.0) * (20.0 - 1.0) / (1.0 - 0.0)) * AGP_SnowContrast ) ) * ( _TopIntensity * AGP_SnowIntensity ) ) ) * saturate( (0.0 + (WorldPosition.y - AGH_SnowMinimumHeight) * (1.0 - 0.0) / (( AGH_SnowMinimumHeight + AGH_SnowFadeHeight ) - AGH_SnowMinimumHeight)) ) );
				half2 texCoord279 = IN.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_cast_0 = (( 1.0 - tex2D( _BaseAOANoiseMask, ( texCoord279 * _TopNoiseUVScale ) ).a )).xxxx;
				#ifdef _TOPENABLENOISE_ON
				float4 staticSwitch270 = temp_cast_0;
				#else
...
Node;AmplifyShaderEditor.FunctionNode;328;-4352,384;Inherit;False;AG Global Snow - Props;-1;;6;13862ff5366d2ea409a2b82c7b7675e1;0;4;22;FLOAT;0;False;24;FLOAT;0;False;23;FLOAT;0;False;25;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;346;896,-2096;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;345;896,-2096;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;336;896,-2176;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;335;896,-2176;Half;False;True;-1;2;;0;12;ANGRYMESH/Nature Pack/URP/Detail Props Snow;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;40;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,True,_Strenght1;0;  Normal Distortion;0.5,False,;0;  Scattering;1,False,;0;  Direct;0.8,False,;0;  Ambient;1,False,;0;  Shadow;1,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;1;637860573925902896;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;337;896,-2176;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;338;896,-2176;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=1C6AD531D61924E13E4EC1F2F52903D8EF06137F